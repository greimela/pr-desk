...
`author` is optional. Omit it to follow the signed-in account. The refresh interval must be at least 30 seconds. Team review requests use their team names by default; `review_labels` can shorten them per repository.
